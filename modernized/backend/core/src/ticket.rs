...
impl NewThreadEntry {
    ...
    /// Build a sanitised internal note (`N`).
    ///
    /// @implements FS-021.4: internal notes are staff-only thread entries.
    pub fn note(poster: impl Into<String>, staff_id: i32, body: &str) -> Self {
        Self {
